...
/** O mesmo olhinho das telas de senha do sistema. */
                  ...
                  {linha.senha && (
                    <>
                      <button
                        ...
                        title={visiveis[i] ? 'Ocultar a senha' : 'Mostrar a senha'}
                        aria-label={visiveis[i] ? 'Ocultar a senha' : 'Mostrar a senha'}
                        style={{ display: 'inline-flex', alignItems: 'center', verticalAlign: 'middle' }}
                      >
                        <Olho aberto={!!visiveis[i]} />
                      </button>{' '}
                      <button
                        type="button"
                        className="btn btn-outline btn-sm"
