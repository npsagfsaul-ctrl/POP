  ...
  return (
    <>
      ...
      <nav className="sidebar-nav">
        ...
        <Link href="/comercial" className={`sidebar-link ${isActive('/comercial') ? 'active' : ''}`}>
          <IconBriefcase />
          Comercial
        </Link>
        ...
        {isAdmin && (
          <>
            ...
            {/* Comunicados, Lembretes e Ocorrências viraram abas de uma tela só. */}
            <Link href="/admin/avisos" className={`sidebar-link ${isActive('/admin/avisos') ? 'active' : ''}`}>
              <IconMural />
              Avisos
            ...
            <Link href="/admin/premiacao" className={`sidebar-link ${isActive('/admin/premiacao') ? 'active' : ''}`}>
              <IconClipboard />
