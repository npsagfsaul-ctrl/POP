      ...
      <div className="page-header">
        ...
        {adminMode && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <LogoutButton />
            <a href="/api/pops/export?todos=1" className="btn btn-secondary btn-sm" title="Excel com os POPs de todos os setores, uma aba por setor">
              ⬇ POPs (Excel)
            </a>
            <a href="/api/pops/export/pdf?todos=1" className="btn btn-secondary btn-sm" title="PDF com os POPs de todos os setores, um por página">
              ⬇ POPs (PDF)
            </a>
