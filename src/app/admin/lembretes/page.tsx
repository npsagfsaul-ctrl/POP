...
export default async function LembretesAdminPage() {
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1 className="page-title">Gerenciar Lembretes</h1>
          <nav className="breadcrumb">
            <Link href="/" className="breadcrumb-link">Mural</Link>
            <span className="breadcrumb-sep">›</span>
            <span className="breadcrumb-current">Lembretes</span>
          </nav>
        </div>
      </div>
            ...
            <table>
              ...
              <tbody>
                {lembretes.map((l) => {
                  ...
                  const passou = dataLembrete < hoje;
                  ...
                  return (
                    <tr key={l.id} style={{ opacity: passou ? 0.5 : 1 }}>
                      <td>
                        ...
                        {passou && <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginLeft: 6 }}>passado</span>}
                      </td>
